// THIS IS COPIED AND MODIFIED FROM: https://github.com/ggruen/CloudKitSyncMonitor
// - remove public
// - remove shared
// - register with a specific persistentContainer
...
@MainActor class SyncMonitor: ObservableObject {
    ...
    public init(
        ...
        if #available(iOS 14.0, macCatalyst 14.0, *) { // Crashes on 13.7 w/o this, even though we have @available
            NotificationCenter.default.publisher(for: NSPersistentCloudKitContainer.eventChangedNotification, object: persistentContainer)
